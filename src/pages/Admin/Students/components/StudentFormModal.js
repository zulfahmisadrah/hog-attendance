...
export function StudentFormModal(props) {
    ...
    const handleInitFormData = (formData) => {
        let {user, ...student} = formData;
        const newFormData = {...user};
        newFormData.student = {...student};
        newFormData.id = newFormData.student?.id;
        newFormData.student.department_id = newFormData.student?.department?.id;
        newFormData.faculty = newFormData.student?.department?.faculty?.id;
